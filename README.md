# Edge-Cloud Vlog System: Creative Integration with Sony Camera
...
- 🌐 IPFS/NFT 上链登记：原创视频生成 NFT 并注册上链
- 🎥 多机位控制：多个边缘节点自动协同切换机位
- ☁️ 云端 AI 剪辑服务：基于云函数自动生成 vlog 剪辑视频
- 📡 边缘感知推理：根据场景亮度/人脸动态决定是否上传或直播
